...
%
% Estimates temporal alignment between click stimuli and video frames,
...
plot(offset, broad_sweep, 'color', [0.9 0.1 0.9])
...
plot(offset, narrow_sweep, 'color', [0.6 0.2 0.6])
