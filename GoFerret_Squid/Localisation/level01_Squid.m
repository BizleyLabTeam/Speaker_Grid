...
%
% Training level
% animal will be required to go to start zone and then to reward spout for
% reward. Reward is signalled by 5 kHz tone and flashing LED.
% start zone is monitored by head tracking.
